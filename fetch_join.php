...
$sql = "select li.employeer_id, li.name, li.surname, li.lastname, li.sex, li.wage, lili.team, lili.number_empl, lili.max_salary
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc())     {
        ...
        echo "<td>".$row['number_empl']."</td><td>".$row['max_salary']."</td>";
                   }
}
else {
    echo "0 results";
